To run the example correcly, first you have to create the .env files using the same fields of env.example in the same locations and insert your gemini api key. 
